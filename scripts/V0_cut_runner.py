...
if __name__ == "__main__":
  ...
  for cut_value in cut_values:
    ...
    if os.path.isfile("{}/AnalysisResults_{}_{}.root".format(output_dir, cut_parameters[par_index], cut_value)):
    ...
    os.system("mv {}/AnalysisResults.root {}/AnalysisResults_{}_{}.root".format(cwd, output_dir, cut_parameters[par_index], cut_value))
